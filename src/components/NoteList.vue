...
<div class="overflow-auto p-5">
    <div v-if="notes.length > 0" class="flex flex-col">
    <div v-for="note in notes" :key="note.id" class="border-[1px] border-b-0 last:border-b-[1px] border-collapse border-zinc-900">
